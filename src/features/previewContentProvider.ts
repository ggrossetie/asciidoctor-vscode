...
export class AsciidocContentProvider {
  ...
  public async providePreviewHTML (
    ...
    const { output: body } = await this.engine.convertPreview(sourceUri, config.previewFrontMatter === 'hide', asciidocDocument.getText(), 'webview-html5', this.context, editor)
